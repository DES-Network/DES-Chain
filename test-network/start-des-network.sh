...
echo "To deploy the DES network contract that will keep track of regulators and whitelisted nodes, run './runscript.sh deploy-and-init.js'. Note that you will not be able to make any private transactions until this is done."
