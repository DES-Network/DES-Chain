...
IPC=$BASE_PATH/qdata/dd1/geth.ipc PRIVATE_CONFIG=qdata/c1/tm.ipc nohup ./bin/geth --datadir qdata/dd1 $ARGS --vmodule *=5 --permissioned --raftport 50401 --rpcport 22000 --port 21000 --debug --unlock 0 --password passwords.txt 2>>qdata/logs/1.log &
IPC=$BASE_PATH/qdata/dd2/geth.ipc PRIVATE_CONFIG=qdata/c2/tm.ipc nohup geth --datadir qdata/dd2 $ARGS --vmodule *=5 --permissioned --raftport 50402 --rpcport 22001 --port 21001 2>>qdata/logs/2.log &
set +v
